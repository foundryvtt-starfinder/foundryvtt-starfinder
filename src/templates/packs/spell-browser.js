...
class SpellBrowserStarfinder extends ItemBrowserStarfinder {
  constructor(app) {
    ...
    Hooks.on('ready', e => {
      ...
      if (settings == '') {
        ...
        console.log('Starfinder System | Spell Browser | Creating settings');
        settings = {};
        ...
        console.log('Starfinder System | Spell Browser | Loading settings');
  ...
  async loadSpells() {
    console.log('Starfinder System | Spell Browser | Started loading spells');
    const foundSpells = '';
    const unfoundSpells = '';
    const spells = {};
    let classesArr = [];
    ...
    for await (const {
      ...
      console.log(`Starfinder System | Spell Browser | ${pack.metadata.label} - ${content.length} entries found`);
    ...
    if (unfoundSpells !== '') {
      console.log('Starfinder System | Spell Browser | List of Spells that don\'t have a class assosiated to them:');
    ...
    console.log('Starfinder System | Spell Browser | Finished loading spells');
    return spells;
  }
