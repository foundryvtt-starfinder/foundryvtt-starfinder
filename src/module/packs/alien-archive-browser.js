...
class AlienArchiveBrowserSFRPG extends ItemBrowserSFRPG {
    ...
    async loadItems() {
        console.log('SFRPG | Compendium Browser | Started loading actors');
        const items = [];
        ...
        console.log('SFRPG | Compendium Browser | Finished loading actors');
        return items;
    }
