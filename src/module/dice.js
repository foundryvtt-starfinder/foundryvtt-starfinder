    ...
    */
    static async damageRoll({ event = new Event(''), parts, linkedAttackRoll, criticalData, rollContext, title, speaker, flavor, chatMessage = true, onClose, dialogOptions }) {
        ...
        for (const rollInstance of rollInfo.rolls) {
            ...
            if (isCritical) {
                await this._prepareCriticalInfo(tags, htmlDataFields, criticalData, finalFormula);
            }
    ...
    static async _prepareCriticalInfo(tags, htmlDataFields, criticalData, finalFormula) {
